...
const MapCard = ({ lat, lon }) => {
  ...
  return (
    <div className="sky-details-card" style={{ padding: 0, overflow: 'hidden', position: 'relative', width: '300px', height: '400px' }}>
      <img 
        src={mapUrl} 
        alt="Location Map" 
        style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'flexwrap' }} 
      />

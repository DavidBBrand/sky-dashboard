    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '15px', width: '100%' }}>
        <div style={{
          width: '120px',
          height: '120px',
          backgroundColor: '#1a1a1a', // Keep the dark background for the moon "shadow"
          borderRadius: '50%',
          position: 'relative',
          overflow: 'hidden',
          ...
          <div style={{
            width: `${percentage}%`,
            height: '100%',
            backgroundColor: '#fefcd7', // The moon color stays yellow/white
  ...
  return (
    <div className="moon-card">
      <p style={{ 
        ...
        letterSpacing: '2px', 
        color: 'var(--text-sub)', // Switched from opacity: 0.6
        marginBottom: '20px',
      ...
      {loading ? (
        <p style={{ color: 'var(--text-main)', fontSize: '0.8rem' }}>Querying Skyfield...</p>
      ) : illumination !== null ? (
